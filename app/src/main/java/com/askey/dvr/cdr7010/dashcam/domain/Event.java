...
public final class Event{
   ...
   public static final int[] nomalEvent ={ACCIDENT_DETECTION,LONG_RUNNING,ABRUPT_HANDLE,
           WOBBLE,FRONT_COLLISION_WARNING,RIGHT_LANE_DEPARTURE_WARNING,LEFT_LANE_DEPARTURE_WARNING,
           START_DELAY,RAPID_ACCELERATION,RAPID_DECELERATION,REVERSE_RUN, ZONE_30,
   ...
   public static final int[] equipmentFailureEvent = {EQUIPMENT_FAILURE};
   ...
   0x032D,0x030E,0x032F,0x0330,0x0331,0x0332,0x0333,0x0334,0x0336,0x0337,0x0338,0x0339,0x033A,0x033B,0x033D,0x0804};
