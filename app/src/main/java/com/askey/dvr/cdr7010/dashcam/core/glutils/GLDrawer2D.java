...
public class GLDrawer2D {
	private static final String LOG_TAG = GLDrawer2D.class.getSimpleName();
	...
	public static int loadShader(final String vss, final String fss) {
		...
		if (compiled[0] == 0) {
			Logg.e(LOG_TAG, "Failed to compile vertex shader:"
		...
		if (compiled[0] == 0) {
			Logg.w(LOG_TAG, "Failed to compile fragment shader:"
